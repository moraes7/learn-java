...
import com.nicolasmoraes.learnjava.javacore.ZZHpadroesdeprojeto.dominio.AircraftSingletonLazy;
...
public class AircraftSingletonLazyTest01 {
    ...
    private static void bookSeat(String seat) {
        System.out.println(AircraftSingletonLazy.getINSTANCE()); // true
        AircraftSingletonLazy aircraft = AircraftSingletonLazy.getINSTANCE();
        System.out.println(aircraft.bookSeat(seat)); // false
    }
}
